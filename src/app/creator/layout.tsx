    ...
    <div style={{ minHeight: "100vh", background: "#0A0A0F", fontFamily: "'Inter', sans-serif", color: "#E2E8F0" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <span style={{ fontSize: 15, fontWeight: 700, color: "#E2E8F0" }}>Creator Portal</span>
          <span style={{
            fontSize: 10, fontWeight: 700, background: "linear-gradient(135deg,#7C3AED,#EC4899)",
            color: "#fff", padding: "2px 8px", borderRadius: 20, textTransform: "uppercase", letterSpacing: 0.5
          }}>AFFILIATE</span>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          {creator?.photoURL && (
            <img src={creator.photoURL} alt={creator.name} style={{ width: 34, height: 34, borderRadius: "50%", border: "2px solid rgba(124,58,237,0.4)", objectFit: "cover" }} />
          )}
          <button
            onClick={handleSignOut}
            style={{
              background: "rgba(239,68,68,0.12)", border: "1px solid rgba(239,68,68,0.25)",
              color: "#F87171", padding: "7px 14px", borderRadius: 8, cursor: "pointer",
