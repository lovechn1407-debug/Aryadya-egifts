  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        {/* Meta Pixel Code — native script for immediate execution on every page */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
      ...
      <body>
        ...
        <noscript>
          ...
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1383745786980492&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        <AuthProvider>
