...
const BUSINESS_NAME = "Aradhya E-Gifts";
const BUSINESS_ENTITY = "AS-Studios";
const WEBSITE_URL = "https://aradhyagifts.in";
const CONTACT_EMAIL = "support@aradhyagifts.in";
...
function TermsContent() {
  return (
    <section id="terms">
      ...
      <p style={{ color: "#7C3AED", fontSize: 13, fontWeight: 700, marginBottom: 24 }}>
      ...
      <p style={paragraphStyle}>
        ...
        <a href={WEBSITE_URL} style={{ color: "#7C3AED", textDecoration: "none", fontWeight: 700 }}>{WEBSITE_URL}</a>{" "}
      ...
      <p style={paragraphStyle}>
        <strong>Your Content:</strong> You retain ownership of any original content you upload to the Platform. The limited license granted to us is solely for the purpose of delivering the E-Gift service.
      </p>
      ...
      <p style={paragraphStyle}>
        Since {BUSINESS_NAME} deals exclusively in digital products, delivery is instant and electronic:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        To the maximum extent permitted by applicable law, {BUSINESS_NAME} and {BUSINESS_ENTITY}, including their owners, directors, employees, affiliates, and agents, shall not be liable for:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        Our total aggregate liability for any claims arising from or related to these Terms or the use of the Platform shall not exceed the amount paid by you for the specific E-Gift in question.
      </p>

      <h3 style={heading3Style}>11. Indemnification</h3>
      <p style={paragraphStyle}>
        You agree to indemnify, defend, and hold harmless {BUSINESS_NAME}, {BUSINESS_ENTITY}, and their owners, directors, employees, and agents from and against any and all claims, liabilities, damages, losses, costs, and expenses (including reasonable attorney&apos;s fees) arising from or related to:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        These Terms shall be governed by and construed in accordance with the laws of India. Any disputes arising out of or in connection with these Terms or the use of the Platform shall be subject to the exclusive jurisdiction of the courts located in India.
      </p>

      <h3 style={heading3Style}>13. Amendments to Terms</h3>
      <p style={paragraphStyle}>
        We reserve the right to modify, update, or revise these Terms at any time without prior notice. The updated Terms will be posted on this page with a revised &ldquo;Last Updated&rdquo; date. Your continued use of the Platform after any changes constitutes your acceptance of the revised Terms. We encourage you to review this page periodically.
      </p>
      ...
      <ul style={ulStyle}>
        ...
        <li style={liStyle}><strong>Email:</strong> <a href={`mailto:${CONTACT_EMAIL}`} style={{ color: "#7C3AED", textDecoration: "none", fontWeight: 700 }}>{CONTACT_EMAIL}</a></li>
        <li style={liStyle}><strong>Website:</strong> <a href={WEBSITE_URL} style={{ color: "#7C3AED", textDecoration: "none", fontWeight: 700 }}>{WEBSITE_URL}</a></li>
      </ul>
    </section>
  );
}
...
function PrivacyContent() {
  return (
    <section id="privacy">
      ...
      <p style={paragraphStyle}>
        {BUSINESS_NAME} (&ldquo;we,&rdquo; &ldquo;our,&rdquo; &ldquo;us&rdquo;), a product of {BUSINESS_ENTITY}, is committed to protecting the privacy and personal data of all visitors and users of our website <a href={WEBSITE_URL} style={{ color: "#7C3AED", textDecoration: "none", fontWeight: 700 }}>{WEBSITE_URL}</a> (the &ldquo;Platform&rdquo;). This Privacy Policy explains what information we collect, how we use it, how we store it, who we share it with, and what rights you have regarding your data.
      </p>
      <p style={paragraphStyle}>
        By using the Platform, you consent to the collection, use, and storage of your information as described in this Privacy Policy. If you do not agree to this Privacy Policy, please do not use the Platform.
      </p>
      ...
      <p style={{ ...paragraphStyle, fontWeight: 700, marginBottom: 8 }}>a) Information You Provide Directly:</p>
      <ul style={ulStyle}>
      ...
      <p style={{ ...paragraphStyle, fontWeight: 700, marginBottom: 8 }}>b) Information Collected Automatically:</p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        We use trusted third-party services to deliver and improve our Platform. These providers process data on our behalf and are bound by their respective privacy policies:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        We do <strong>NOT</strong> sell, rent, trade, or otherwise commercially share your personal information with any third party for marketing or advertising purposes. We may disclose your information only in the following circumstances:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        <strong>Important:</strong> Since E-Gifts are designed to be shared via unique URLs, any person who possesses the link to your finalized E-Gift will be able to view its contents. Do not include highly sensitive personal information (such as passwords, Aadhaar numbers, bank details, or other financial data) in your E-Gifts.
      </p>

      <h3 style={heading3Style}>7. Data Retention</h3>
      <p style={paragraphStyle}>
        We retain your data for as long as it is necessary to provide the services and fulfil the purposes described in this Privacy Policy:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        ...
        <a href={`mailto:${CONTACT_EMAIL}`} style={{ color: "#7C3AED", textDecoration: "none", fontWeight: 700 }}>{CONTACT_EMAIL}</a>.
...
function RefundContent() {
  return (
    <section id="refund">
      ...
      <p style={paragraphStyle}>
        At {BUSINESS_NAME}, we strive to ensure that every customer has a positive experience with our digital gifting platform. Please read our Refund Policy carefully before making a purchase. By completing a purchase on our Platform, you acknowledge and agree to the following refund terms.
      </p>

      <h3 style={heading3Style}>1. Nature of Products</h3>
      <p style={paragraphStyle}>
        All products sold on {BUSINESS_NAME} are <strong>digital products</strong> — specifically, personalised digital greeting cards, surprise webpages, and interactive microsites (E-Gifts). These are non-physical, intangible goods that are delivered instantly and electronically upon successful payment.
      </p>

      <h3 style={heading3Style}>2. No Refund Policy (General Rule)</h3>
      <p style={paragraphStyle}>
        Due to the instant, digital nature of our products, <strong>all sales are final and non-refundable</strong> under normal circumstances. Once a payment is successfully processed and you gain access to the Live Editor for your purchased E-Gift, we consider the product as delivered. Reasons for this policy include:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        Despite the general no-refund policy, we understand that exceptional situations may arise. We may issue a partial or full refund at our sole discretion in the following scenarios:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        If you believe your situation qualifies for a refund under the exceptions listed above, please follow these steps:
      </p>
      <ul style={ulStyle}>
        <li style={liStyle}><strong>Step 1:</strong> Send an email to <a href={`mailto:${CONTACT_EMAIL}`} style={{ color: "#7C3AED", textDecoration: "none", fontWeight: 700 }}>{CONTACT_EMAIL}</a> with the subject line: &ldquo;Refund Request — [Your Order ID]&rdquo;</li>
      ...
      <p style={paragraphStyle}>
        We encourage you to contact us directly before initiating a chargeback or payment dispute with your bank or payment provider. Unauthorized chargebacks may result in suspension of your access to the Platform and further investigation.
      </p>
...
function ReturnContent() {
  return (
    <section id="return">
      ...
      <p style={paragraphStyle}>
        {BUSINESS_NAME} exclusively sells <strong>digital products</strong> — personalised interactive digital greeting cards, surprise webpages, and microsites (E-Gifts). Since our products are entirely digital and intangible in nature, there is <strong>no physical product to return</strong>.
      </p>
      <p style={paragraphStyle}>
        The concept of a traditional &ldquo;return&rdquo; (sending back a physical item) does not apply to our business model. Once a digital product is purchased and delivered (i.e., access to the Live Editor is granted), the product is considered consumed and cannot be &ldquo;returned.&rdquo;
      </p>
      ...
      <p style={paragraphStyle}>
        If you experience any technical issues, defects, or problems with your purchased E-Gift, please do not hesitate to contact us. We are committed to resolving any legitimate technical issues:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        Since digital product delivery is instant, orders cannot be cancelled after payment is completed. If you wish to cancel an order:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        For any questions about our Return Policy or for technical assistance with your E-Gift, please contact us:
      </p>
      <ul style={ulStyle}>
        <li style={liStyle}><strong>Email:</strong> <a href={`mailto:${CONTACT_EMAIL}`} style={{ color: "#7C3AED", textDecoration: "none", fontWeight: 700 }}>{CONTACT_EMAIL}</a></li>
        <li style={liStyle}><strong>Website:</strong> <a href={WEBSITE_URL} style={{ color: "#7C3AED", textDecoration: "none", fontWeight: 700 }}>{WEBSITE_URL}</a></li>
...
function DisclaimerContent() {
  return (
    <section id="disclaimer">
      ...
      <p style={paragraphStyle}>
        The information, content, and services provided on {BUSINESS_NAME} (<a href={WEBSITE_URL} style={{ color: "#7C3AED", textDecoration: "none", fontWeight: 700 }}>{WEBSITE_URL}</a>) are provided on an &ldquo;as is&rdquo; and &ldquo;as available&rdquo; basis. Please read this disclaimer carefully before using our Platform.
      </p>

      <h3 style={heading3Style}>1. General Disclaimer</h3>
      <p style={paragraphStyle}>
        {BUSINESS_NAME} and {BUSINESS_ENTITY} make no representations or warranties of any kind, express or implied, regarding the operation, availability, accuracy, completeness, or reliability of the Platform, its content, or the E-Gift services provided. To the fullest extent permissible by applicable law, we disclaim all warranties, including but not limited to:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        The content on this Platform is provided for informational and entertainment purposes only. Nothing on this website constitutes professional, legal, financial, medical, or any other form of advice. You should not rely on any content on this Platform as a substitute for professional consultation.
      </p>

      <h3 style={heading3Style}>3. User Content Disclaimer</h3>
      <p style={paragraphStyle}>
        {BUSINESS_NAME} is a platform that enables users to create personalised digital gifts using their own content. We do not review, monitor, endorse, or take responsibility for User Generated Content, including:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        Our Platform may contain links to or integrations with third-party websites, services, and content (including but not limited to Razorpay, Firebase, ImgBB, EmailJS, YouTube, Spotify, and WhatsApp). These third-party services are independent entities and are not under our control. We disclaim all responsibility for:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        We encourage you to review the privacy policies and terms of service of any third-party services you interact with through our Platform.
      </p>

      <h3 style={heading3Style}>5. E-Gift Availability &amp; Link Permanence</h3>
      <p style={paragraphStyle}>
        While we endeavour to keep all finalized E-Gift links active and accessible permanently, we cannot guarantee indefinite availability. Circumstances that may affect link availability include:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        Under no circumstances shall {BUSINESS_NAME}, {BUSINESS_ENTITY}, or their owners, directors, employees, affiliates, or agents be held liable for any direct, indirect, incidental, special, consequential, exemplary, or punitive damages arising from:
      </p>
      <ul style={ulStyle}>
      ...
      <p style={paragraphStyle}>
        By using this Platform, you agree to indemnify and hold harmless {BUSINESS_NAME}, {BUSINESS_ENTITY}, and their respective owners, directors, employees, and agents from any claims, damages, liabilities, costs, or expenses arising from your use of the Platform, your violation of these Terms, or your violation of any rights of any third party.
      </p>

      <h3 style={heading3Style}>9. Changes to This Disclaimer</h3>
      <p style={paragraphStyle}>
        We reserve the right to modify this Disclaimer at any time. Any changes will be effective immediately upon posting the revised Disclaimer on this page with an updated &ldquo;Last Updated&rdquo; date. Your continued use of the Platform after changes are posted constitutes your acceptance of the revised Disclaimer.
      </p>
...
export default function LegalPage() {
  ...
  /* On section change, update URL hash without scroll */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(233,30,140,0.06), transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        >
          All the legal details, policies, and guidelines you need to know about
          using {BUSINESS_NAME}. We believe in complete transparency with our
          customers.
        </p>
      </div>
      ...
      >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: isActive
                    ? "linear-gradient(135deg, rgba(124,58,237,0.08), rgba(233,30,140,0.04))"
                    : "transparent",
                  transition: "all 0.2s",
                  textAlign: "left",
                  width: "100%",
                ...
                {isActive && (
                  <div
                    style={{
                      ...
                      borderRadius: 4,
                      background:
                        "linear-gradient(180deg, #7C3AED, #E91E8C)",
                    }}
                  />
                )}
        ...
        >
          ...
          >
            ...
            <span
              style={{
                transform: isMobileNavOpen ? "rotate(180deg)" : "rotate(0)",
          ...
          <div
            style={{
              maxHeight: isMobileNavOpen ? 400 : 0,
              overflow: "hidden",
        ...
        >
          ...
          {activeSection === "refund" && <RefundContent />}
          {activeSection === "return" && <ReturnContent />}
      ...
      >
        ...
        >
          <span>
            © {new Date().getFullYear()} {BUSINESS_NAME} — A Product of{" "}
            <strong style={{ color: "#94A3B8" }}>{BUSINESS_ENTITY}</strong>
          </span>
          ...
          <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}>
            Made with{" "}
            <span style={{ color: "#EF4444" }}>❤</span> in India
          </span>
        </div>
      </div>
