...
export function Cake({ onComplete }: Props) {
  ...
  return (
    <div className="flex flex-col items-center select-none">
      {cut && (
        <p className="text-2xl md:text-3xl font-display italic mb-6 animate-bliss-fade-in-up"
           style={{ background: "linear-gradient(135deg, #ffd9ec, #ff6bb0, #b266ff)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
          Make a wish ✨
        </p>
      )}
