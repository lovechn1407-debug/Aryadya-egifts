...
export default function Confess({
  ...
  useEffect(() => {
    ...
    const runPreload = async () => {
      ...
      const assets = [
        customData.photo1, customData.photo2, customData.photo3,
    ...
    <div className="relative min-h-screen w-full overflow-hidden select-none noise-overlay bg-background text-foreground font-sans">
      {preloading && (
        <div style={{ position: "fixed", inset: 0, zIndex: 99999, background: "#06060A", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "'Inter', sans-serif" }}>
          <div style={{ width: 44, height: 44, borderRadius: "50%", border: "3.5px solid rgba(235, 71, 153, 0.15)", borderTopColor: "#eb4799", animation: "tmpl-spin 0.9s cubic-bezier(0.16, 1, 0.3, 1) infinite", marginBottom: 20 }} />
          ...
          <div style={{ width: 240, height: 4, background: "rgba(255,255,255,0.06)", borderRadius: 2, overflow: "hidden", marginBottom: 12 }}>
            <div style={{ height: "100%", background: "#eb4799", width: `${preloadProgress}%`, transition: "width 0.3s ease" }} />
          </div>
          <p style={{ color: "#eb4799", fontSize: 13, opacity: 0.8 }}>{preloadText}</p>
